...
```
[assets/platform-demo.mp4](https://drive.google.com/drive/folders/19iEBML7CxSyP4fvyGlJNynumo4Xv3z-L?usp=sharing)
```
...
SkillEngine --> Tailwind

SkillEngine --> Theme

SkillEngine --> Supabase

SkillEngine --> BestPractices

BestPractices --> GeneratedApplication
```
...
flowchart TD
    ...
    App --> ProjectBuilder["Project Builder"]
    App --> AIChat["AI Chat"]
...
User->>Next.js: Submit Requirements

Next.js->>NestJS: Generate Project

NestJS->>Claude AI: Generate Code

Claude AI-->>NestJS: Generated Files

NestJS-->>Next.js: Project Response

Next.js-->>User: Generated Application
```
